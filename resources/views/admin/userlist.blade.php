...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Userlist</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <tbody>
                          @foreach($users as $user) 
                            <tr>
                                ...
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap">xxxxxxxx</div>
                                ...
                                <div class="font-medium whitespace-no-wrap">{{ \Carbon\Carbon::parse($user->created_at)->diffForHumans() }}</div>
                                </td>
