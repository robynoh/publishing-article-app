...
<div class="intro-y datatable-wrapper box p-5 mb-5" id="sms" <?php if (empty($errors->any())){ ?> style="display:none" <?php }?>>
                <form action="../smstocontacts" method="POST">
                {{ csrf_field() }} 
                ...
                <div class="grid grid-cols-12 gap-6 mt-0">
                    ...
                    <div class="intro-y datatable-wrapper box p-5 mt-0">
                        <?php if($contactlists->count()==0){?>
                            ...
                            <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11"> <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> There is no birthday celebrant today! </div>
