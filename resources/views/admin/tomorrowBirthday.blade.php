...
@section('title')
    <title> Admin | tomorrow Anniversary </title>
@endsection
@section('content')
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <h1 class="text-lg font-medium mr-auto" style="font-size:23px">
                    Tomorrow's Birthday Celebrants
                    </h1>
               <br/>
...
<a id="cswishes" href="javasrcipt:void(0);" onclick="hideMsg()" class="button box bg-theme-6 text-white mr-2 flex items-center  ml-auto sm:ml-0" <?php if (empty($errors->any())){ ?> style="display:none"<?php } ?>>
                                               ...
                                               <i data-feather="message-circle" class="w-4 h-4 mr-2"></i>     Open Message Box </a>
                              
                               
                       
                                              
                       
                                               <a href="/admin/listDetail/{{$lists->id}}/birthday" class="button box bg-theme-1 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                ...
                <form action="../smstocontactstomorrow" method="POST">
                {{ csrf_field() }} 
...
@endforeach
</select>   <input name="listid" type="hidden"  value="{{ $lists->id }}">
...
<div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11"> <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> There is no birthday celebrant tomorrow! </div>
    ...
    <table class="table" style="font-size:14px">
         <thead>
             <tr>
                 ...
                 <th class="border border-b-2 whitespace-no-wrap">Date of Birth</th>
                 <th class="border border-b-2 whitespace-no-wrap">Contact</th>
                 <th class="border border-b-2 whitespace-no-wrap">Remarks</th>
             </tr>
         </thead>
         <tbody>
                          ...
                          @foreach($contactlists as $contactlist) 
                            <tr>
                            <td class="border">
                                <input type="checkbox" name="contacts[]" class="input border mr-2" value="{{$contactlist->phone}}" >
                            ...
                            <td class="border">
                                ...
                                <td class=" border">
                               {{$contactlist->birthMonth}} {{$contactlist->birthDay}} 
                                </td>
