...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <h1 class="text-lg font-medium mr-auto" style="font-size:23px">
                    Contacts who have birthday in <?php echo AdminController::fullmonth($months); ?>
                    </h1>
               <br/>
...
<div class="w-full sm:w-auto flex mt-0 sm:mt-0">
                       ...
                       <a id="cswishes" href="javasrcipt:void(0);" onclick="hideMsg()" class="button box bg-theme-6 text-white mr-2 flex items-center  ml-auto sm:ml-0" <?php if (empty($errors->any())){ ?> style="display:none"<?php } ?>>
                                               ...
                                               <a href="/admin/celebrantsByMonths/{{$lists->id}}" class="button box bg-theme-1 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                                               <i data-feather="chevron-left" class="breadcrumb__icon"></i>     Back to list </a>
             ...
             <input name="senderid" type="text" class="input w-full border mt-2 flex-1 bg-gray-200" placeholder="Enter the name you want to send this message as" value="{{ old('senderid') }}">
