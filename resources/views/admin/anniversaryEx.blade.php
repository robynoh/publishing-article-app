...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <br/>
                 ...
                 <table><tr><td><h1 class="text-lg font-medium mr-auto">   Anniversary </h1></td><td> <i data-feather="chevron-right" class="breadcrumb__icon"></i></td><td><span style="color:#090"><h1 class="text-lg font-medium mr-auto" >{{ucwords($anns)}}</h1></span></td></tr></table>
...
<table>
    <tr>
        <td>
        <a href="/admin/listDetail/{{$lists->id}}/other"  class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i> Go Back </a>             
</td>
<td>
</td>
</tr>
...
<div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    ...
                                    <a href="/admin/anniversary/today/{{$lists->id}}/{{$anns}}/{{$annids}}">
                                    <div class="box p-5">
                                        <div class="flex">
                                            <i data-feather="users" class="report-box__icon text-theme-10"></i> 
                                           
                                        </div>
                                        <div class="text-3xl font-bold leading-8 mt-6"><?php echo $todayanniversary->count(); ?></div>
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                <a href="/admin/anniversary/tomorrow/{{$lists->id}}/{{$anns}}/{{$annids}}">
                                    <div class="box p-5">
                                        <div class="flex">
                                            <i data-feather="users" class="report-box__icon text-theme-11"></i> 
                                            
                                        </div>
                                        <div class="text-3xl font-bold leading-8 mt-6"><?php echo $tomorrowanniversary->count(); ?></div>
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                ...
                                <a href="/admin/anniversaryByMonths/{{$lists->id}}/{{$anns}}/{{$annids}}" >
                                    <div class="box p-5">
                                    <div class="flex">
                                            <i data-feather="filter" class="report-box__icon text-theme-7"></i> 
                                            
                                        </div>
                                        <div class="text-3xl font-bold leading-8 mt-6"><?php echo $monthanniversary->count(); ?></div>
                                        <div class="text-base text-gray-600 mt-1">Celebrants by Month</div>
                                    </div>
</a>
...
<td>  <a href="javascript:void(0);" onclick="show_file_box();" class="button w-60 mr-2 mb-2 flex items-center justify-center bg-theme-14"> <i data-feather="file" class="w-4 h-4 mr-2"></i> Upload Excel Sheet </a>
        ...
        <br/>
        <form action="../multiplecontact/{{$lists->id}}" method="POST">
        {{ csrf_field() }}
