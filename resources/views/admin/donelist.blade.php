...
@section('title')
    <title> Admin | Autoschedule Birthday </title>
@endsection
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Birthday Scheduler</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<div class="intro-y flex flex-col sm:flex-row items-center mt-0">
                    ...
                    <form action="/admin/autosms" method="POST">
...
This List has been activated to send birthday automatically</h1>
      </td>  
    </tr>
</table>
...
<table>
<tr>
<td> <a href="/admin/scheduleList" value="activate" class="button box bg-theme-9 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
