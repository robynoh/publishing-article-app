...
<a href="javascript:;" data-toggle="modal" data-target="#superlarge-modal-size-preview" class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-9 text-white"> <i data-feather="plus" class="w-4 h-4 mr-2"></i> Add Contact </a>             
<?php } ?>
...
<div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    <a href="/admin/todayBirthday/{{$lists->id}}">
                                    <div class="box p-5">
                                        <div class="flex">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                <a href="/admin/tomorrowBirthday/{{$lists->id}}">
                                    <div class="box p-5">
                                        <div class="flex">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                <a href="/admin/celebrantsByMonths/{{$lists->id}}" >
                                    <div class="box p-5">
                                        <div class="flex">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                <a href="/admin/sentMessages/{{$lists->id}}" >
                                    <div class="box p-5">
                                        <div class="flex">
...
<table width="100%"><tr>
                    ...
                    <h1 style="font-size:18px;font-weight:bold">Contacts </h1><td>
                        ...
                        <a href="/admin/smsallcontacts/{{$lists->id}}/birthday" class="button box bg-gray-200 text-theme-9 mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="message-circle" class="breadcrumb__icon"></i> Send SMS to all contacts on this list </a> 
</td>
</tr>
                        </table>  
     ...
     <div class="modal__content">
         ...
         <form  action="/admin/addcontact/{{$lists->id}}" method="POST" >
         {{ csrf_field() }} 
...
<td>  <a href="javascript:void(0);" onclick="show_file_box();" class="button w-60 mr-2 mb-2 flex items-center justify-center bg-theme-14"> <i data-feather="file" class="w-4 h-4 mr-2"></i> Upload Excel Sheet </a>
        ...
        <br/>
        <form action="/admin/multiplecontact/{{$lists->id}}" method="POST">
        {{ csrf_field() }}
