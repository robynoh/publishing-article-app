...
<tr>
                   ...
                   <td><a href="/admin/new_pilot"  class="button w-32 mr-2 flex items-center justify-center bg-theme-9 text-white"> <i data-feather="user-plus" class="w-4 h-4 mr-2"></i> New Pilot </a>             
</td>       
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                        <thead>
                            ...
                            <th class="border-b-2 whitespace-no-wrap"> <input id='selectall' class="input border border-gray-500" type="checkbox" onClick="selectAll(this,'color')">
                                ...
                                <th class="border-b-2 whitespace-no-wrap">CASH BALANCE</th>
                        ...
                        <tbody>
                          @foreach($pilots as $pilot) 
                            ...
                            <input name="allpilots[]" class="input flex-none border border-gray-500" type="checkbox" value="{{$pilot->id}}">
                                ...
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap">{{ ucwords($pilot->firstname)}} {{ucwords($pilot->lastname)}}</div>
                                  
                                </td>
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap" >  {{$pilot->pilotID}}</div>
                                ...
                                <div class="flex sm:justify-center items-center">
                                    ...
                                    <a href="pilot/{{$pilot->id}}" class="button button--sm w-8 mr-1 mb-2 bg-theme-7 text-white" > <i data-feather="external-link" class="w-4 h-4 mr-1"></i></a>
                                  
                                    <a class="button button--sm w-8 mr-1 mb-2 bg-theme-6 text-white" id="deleteUser{{ $pilot->id}}" data-userid="{{$pilot->id}}" href="javascript:void(0)" onclick="showAlert({{$pilot->id}});" > <i data-feather="trash-2" class="w-4 h-4 mr-1"></i></a>
