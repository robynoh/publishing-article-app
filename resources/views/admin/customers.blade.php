                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                        ...
                        <tbody>
                          @foreach($customers as $customer) 
                            <tr>
                            <td class="border-b">
                            <input name="allcustomer[]" class="input flex-none border border-gray-500" type="checkbox" value="{{$customer->id}}">
</td>
                            <td class="border-b">
                                ...
                                <div class="mx-auto text-center">
                                    <div class="w-16 h-16 flex-none image-fit rounded-full overflow-hidden mx-auto">
                                        <img alt="Customer Photo" src="{{$customer->picture}}">
                                    </div>
                                ...
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap" style="color:#090">{{$customer->fname}} {{$customer->lname}}</div>
                                  
                                </td>
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap" style="color:#090">{{$customer->phone}}</div>
                                ...
                                <div class="flex sm:justify-center items-center">
                                    ...
                                    <a href="customer/{{$customer->id}}" class="button button--sm w-8 mr-1 mb-2 bg-theme-7 text-white" > <i data-feather="external-link" class="w-4 h-4 mr-1"></i></a>
                                  
                                    <a class="button button--sm w-8 mr-1 mb-2 bg-theme-6 text-white" id="deleteUser{{ $customer->id}}" data-userid="{{$customer->id}}" href="javascript:void(0)" onclick="showAlert({{$customer->id}});" > <i data-feather="trash-2" class="w-4 h-4 mr-1"></i></a>
