...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Riders Location</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
function initMap(){
  ...
  var locationsRef = firebase.database().ref("RiderLocation");
  ...
  locationsRef.on('child_added', function(snapshot) {
    ...
    marker.addListener('click', (function(data) {
      return function(e) {
        infowindow.setContent("<b>"+data.riderid+"</b><br/>Contact:<span style=\"color:#090\">"+data.phone+"</span>");
        infowindow.open(map, this);
        infowindow.panTo(this.getPosition());
      }
    }(data)));
   ...
   infowindow.event.addDomListener(window, "load", initMap);
