...
@section('title')
    <title> Admin | today Anniversary </title>
@endsection
@section('content')
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <h1 class="text-lg font-medium mr-auto" style="font-size:23px">
                    Tomorrow's {{$anns}} Anniversary Celebrants
                    </h1>
               <br/>
...
<a id="cswishes" href="javasrcipt:void(0);" onclick="hideMsg()" class="button box bg-theme-6 text-white mr-2 flex items-center  ml-auto sm:ml-0" <?php if (empty($errors->any())){ ?> style="display:none"<?php } ?>>
                        ...
                        <a href="/admin/{{$lists->id}}/anniversary/{{$anns}}/{{$annids}}" class="button box bg-theme-1 text-white mr-2 flex items-center  ml-auto sm:ml-0">
...
@endforeach
             ...
             <div class="news__input relative mt-5"> 
                            ...
                            <textarea name="message" class="input w-full bg-gray-200 pl-16 py-6 mt-2 placeholder-theme-13 resize-none" rows="1" placeholder="Type in anniversary wish here..." onkeydown="limitText(this.form.message,this.form.countdown,160);" onkeyup='limitText(this.form.message,this.form.countdown,160);'>{{ old('message') }}</textarea>
                        </div>
        <br/><br/>
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                ...
                <div class="grid grid-cols-12 gap-6 mt-0">
                    ...
                    <div class="intro-y datatable-wrapper box p-5 mt-0">
                        <?php if($contactlists->count()==0){?>
                            ...
                            <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11"> <i data-feather="alert-circle" class="w-6 h-6 mr-2"></i> There is no {{$anns}} anniversary celebrant today! </div>
         ...
         <thead>
             <tr>
                 ...
                 <th class="border border-b-2 whitespace-no-wrap">Anniversary Date</th>
