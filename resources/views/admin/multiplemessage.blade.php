...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">list</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Different messages</a></div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11">  Open the list you want to schedule birthday wishes  </div>
