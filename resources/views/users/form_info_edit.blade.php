...
<div class="mb-2"><b>Page logo</b> </div>
                                <div class="file box rounded-md px-5 pt-8 pb-5 px-3 sm:px-5 relative zoom-in">
                                  
                                    <a href="" class="w-3/5 file__icon file__icon--image mx-auto">
                                        <div class="file__icon--image__preview image-fit">
                                            <img id="blah" alt="Midone Tailwind HTML Admin Template" src="{{ $info->logo }}">
                                        </div>
                                    </a>
...
<br/>
    ...
    <div class="intro-y col-span-12 sm:col-span-12 mt-5">
        ...
        <input name="organisation" type="text" class="input w-full border flex-1" placeholder="Enter the name of your organisation/Business" value="{{ $info->company_name }}">
    </div>
...
<!----
    ...
    <div class="intro-y col-span-12 sm:col-span-12 mt-5"> 
                            ...
                            <textarea name="sms" class="input w-full bg-gray-200 pl-16 py-6 mt-2 placeholder-theme-13 resize-none" rows="1" placeholder="Type in message here..." onkeydown="limitText(this.form.message,this.form.countdown,160);" onkeyup='limitText(this.form.message,this.form.countdown,160);'>{{ $sms->sms }}</textarea>
                        </div>
...
<option value="{{ $sms->senderID }}">{{  $sms->senderID }}</option>
