...
@section('title')
    <title> User | Other Anniversary </title>
@endsection
@section('content')
<?php $anns= UserController::listAnniversary($lists->id);?>
...
<div class="intro-y flex flex-col sm:flex-row items-center ">
                ...
                <div class="intro-y col-span-12 lg:col-span-8">
                        ...
                        <div class="grid grid-cols-12 gap-5 mt-5">
                            ...
                            <div class="font-medium text-base"><a href="/users/{{ $lists->id}}/anniversary/{{$anniversary->name}}/{{ $anniversary->id}}">{{ucwords($anniversary->name)}} </a>
                                   </div>
                                <div class="text-gray-600">{{  UserController::anniversaryCount($anniversary->name,$lists->id)}} Contacts</div>
...
<table width="100%"><tr>
                   ...
                   <a href="/users/smsallcontacts/{{$lists->id}}/other" class=" w-50 mr-2 mb-2 flex ">
