...
<table>
    <tr>
        <td>
        <a href="/users/listDetail/{{$lists->id}}/other"  class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i> Go Back </a>             
</td>
<td>
</td>
</tr>
...
<div class="grid grid-cols-12 gap-6 mt-5">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                    ...
                                    <a href="/users/anniversary/today/{{$lists->id}}/{{$anns}}/{{$annids}}">
                                    <div class="box p-5">
                                        <div class="flex">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                <a href="/users/anniversary/tomorrow/{{$lists->id}}/{{$anns}}/{{$annids}}">
                                    <div class="box p-5">
                                        <div class="flex">
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                ...
                                <a href="/users/anniversaryByMonths/{{$lists->id}}/{{$anns}}/{{$annids}}" >
                                    <div class="box p-5">
                                    <div class="flex">
