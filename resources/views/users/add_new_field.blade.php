...
<div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
                                    ...
                                    <div class="dropdown relative ml-auto sm:hidden">
                                        ...
                                        <div class="dropdown-box mt-5 absolute w-40 top-0 right-0 z-20">
                                            ...
                                            <a href="" class="flex items-center p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"><i data-feather="layout" class="w-6 h-6 mr-2"></i> Basic Field </a>
                                                ...
                                                <a href="/users/create_custom_field" class="flex items-center p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"> <i data-feather="user-check" class="w-6 h-6 mr-2"></i> Personalized Fields </a>
                                   ...
                                   <span style="padding-left:10px">
                                        <a href="/users/create_custom_field" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="user-check" class="w-6 h-6 mr-2"></i> Personalized Fields </a>
</span>
