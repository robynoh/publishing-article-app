...
<div class="grid grid-cols-12 gap-6 mt-0">
                        ...
                        <tbody>
                          @foreach($lists as $list) 
                            <tr>
                                ...
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap" style="color:#090"><b><?php if($list->type=='other'){ echo "Other Anniversary" ;}if($list->type=='birthday'){ echo "Birthdays" ;}if($list->type=='phonebook'){ echo "Phone Book" ;} ?></b></div>
                                ...
                                <td class="border-b w-5">
                                  ...
                                  <!---  <a class="button button--sm w-8 mr-1 mb-2 bg-theme-7 text-white" id="deleteUser{{ $list->id}}" data-userid="{{ $list->id }}" href="javascript:void(0)" onclick="showAlert2({{ $list->id }});" > <i data-feather="edit" class="w-4 h-4 mr-1"></i></a> -->
     ...
     <div class="modal__content">
         ...
         <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
             ...
             <input name="title" type="text" class="input w-full border mt-2 flex-1" placeholder="title" required>
             </div>
            ...
            <select id="type" name="type" class="input w-full border mt-2 flex-1" onchange="showphonetype()">
...
<option value="phonebook">Phone Book</option>
             ...
             <div id="booktype" style="display:none" class="col-span-12 sm:col-span-12"> <label>Phonebook Type</label>
     <div class="flex flex-col sm:flex-row mt-3">
         <div class="flex items-center text-gray-700 mr-2"> <input type="radio" class="input border mr-2" id="horizontal-radio-chris-evans" name="booktype" value="1" checked> <label class="cursor-pointer select-none" for="horizontal-radio-chris-evans">Phone numbers and names</label> </div>
         <div class="flex items-center text-gray-700 mr-2 mt-2 sm:mt-0"> <input type="radio" class="input border mr-2" id="horizontal-radio-liam-neeson" name="booktype" value="2"> <label class="cursor-pointer select-none" for="horizontal-radio-liam-neeson">Only Phone numbers</label> </div>
      </div>
 </div>
