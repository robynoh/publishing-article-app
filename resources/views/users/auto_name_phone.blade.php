...
<a href="javascript:;" data-toggle="modal" data-target="#medium-modal-size-preview" class="button w-45 mr-2 mb-2 flex items-center justify-center bg-theme-9 text-white"> <i data-feather="plus" class="w-4 h-4 mr-2"></i> Schedule SMS</a>             
 ...
 <div class="modal" id="medium-modal-size-preview">
     ...
     <form action="/users/schedulesms/{{$lists->id}}" method="POST">
                {{ csrf_field() }} 
...
<option>AM</option>
             ...
             <div class="news__input relative mt-5"> 
                            ...
                            <textarea required name="message" class="input w-full bg-gray-200 pl-16 py-6 mt-2 placeholder-theme-13 resize-none" rows="1" placeholder="Type in SMS here..." onkeydown="limitText(this.form.message,this.form.countdown,160);" onkeyup='limitText(this.form.message,this.form.countdown,160);'>{{ old('message') }}</textarea>
                        </div>
        <br/><br/>
 ...
 <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="col-span-12 md:col-span-6 xl:col-span-4 xxl:col-span-12 mt-3">
                                ...
                                <?php if($smss->count()<1) {?>
    <div class="rounded-md flex  px-5 py-4 mb-2 ">
    ...
    <?php }?>
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                        ...
                        @foreach($contactlists as $contactlist)
                            <tr>
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap">{{ucwords($contactlist->name)}}</div>
