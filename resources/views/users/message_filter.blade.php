...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">User</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Sent Messages</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <h1 class="text-lg font-medium mr-auto mb-5" >
                    Message History ({{$filtermonth}}, {{$filteryear}})
                    </h1>
...
<td>
                            ...
                            <td>
 <a href="/users/sentMessages" class="button w-32 mr-2 mb-0 flex items-center justify-center bg-theme-1 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i> Back </a>             
</td>                        
</tr>
                                ...
                                <div class="intro-y">
                                    ...
                                    <div class="flex px-5 py-3"> 
                                            ...
                                            <div class="w-56 flex-none flex items-center mr-10">
                                                <input name="contacts[]" class="input flex-none border border-gray-500" type="checkbox">
