...
<table>
<tr>
<td> <a href="/users/new_field_edit" value="activate" class="button box bg-theme-10 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
<i data-feather="plus" class="w-4 h-4 mr-2"></i> Add new Field </a></td>
                            <td> <a href="/users/create_form_edit" value="activate" class="button box bg-theme-7 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
