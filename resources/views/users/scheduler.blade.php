...
<div> <label><b>Time to send SMS on birthday</b></label>
     <div class="flex items-center text-gray-700 mt-2"> <input type="radio" class="input border mr-2" id="vertical-radio-chris-evans" name="time" value="12:00 AM"> <label class="cursor-pointer select-none" for="vertical-radio-chris-evans">12:00 AM</label> </div>
     <div class="flex items-center text-gray-700 mt-2"> <input type="radio" class="input border mr-2" id="vertical-radio-liam-neeson" name="time" value="05:00 AM"> <label class="cursor-pointer select-none" for="vertical-radio-liam-neeson">05:00 AM</label> </div>
     <div class="flex items-center text-gray-700 mt-2"> <input type="radio" class="input border mr-2" id="vertical-radio-daniel-craig" name="time" value="07:00 AM"> <label class="cursor-pointer select-none" for="vertical-radio-daniel-craig">07:00 AM</label> </div>
 </div>
...
<?php if(UserController::autostatus($list->id) !=""){?>
        
    <i data-feather="flag" class="w-4 h-4"></i><?php }else{?>

        <?php if($list->type=='other'||$list->type=='phonebook'){?>
            
            <a href="javascript:;" class="tooltip button inline-block " title="You can not send same SMS to contacts on this list">
    ...
    <input type="radio" name="listid[]" class="input border mr-2" value="{{$list->id}}" >
    <?php }?>
<?php }?>
