...
<td>
         ...
         <button name="action" value="filter"  class="button box bg-theme-11 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
...
<td>
 <button name="action" value="delete" class="button w-32 mr-2 mb-0 flex items-center justify-center bg-theme-9 text-white"> <i data-feather="send" class="w-4 h-4 mr-2"></i> Resend </button>             
</td>                     
</tr>
