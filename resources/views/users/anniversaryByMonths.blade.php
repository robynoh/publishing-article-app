...
<div class="intro-y flex flex-col sm:flex-row items-center mt-0">
                     <a href="/users/{{$lists->id}}/anniversary/{{$anns}}/{{$annids}}" class="button box bg-theme-1 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    ...
                    <?php $conlists=UserController::annpermonth($lists->id,'Jan',$anns); ?>
                        <table width="100%"><tr>
                            <td width="80%">
                    <h1 >January </h1><td>
                        <td>
          ...
          <?php  if($conlists->count()>0){?>
                   <a href="/users/annmonthExtract/{{'Jan'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
...
<br/><br/>
<?php $conlistsfeb=UserController::annpermonth($lists->id,'Feb',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>February </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsfeb->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Feb'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsmar=UserController::annpermonth($lists->id,'Mar',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>March </h1><td>
                        <td>
                        <?php  if($conlistsmar->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Mar'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsapr=UserController::annpermonth($lists->id,'Apr',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>April </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsapr->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Apr'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsmay=UserController::annpermonth($lists->id,'May',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>May </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsmay->count()>0){?>
                            <a href="/users/annmonthExtract/{{'May'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsjun=UserController::annpermonth($lists->id,'Jun',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>June </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsjun->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Jun'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsjul=UserController::annpermonth($lists->id,'Jul',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>July </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsjul->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Jul'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<?php $conlistsaug=UserController::annpermonth($lists->id,'Aug',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>August </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsaug->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Aug'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistssep=UserController::annpermonth($lists->id,'Sep',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>September </h1><td>
                        <td>
                        <?php  if($conlistssep->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Sep'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsoct=UserController::annpermonth($lists->id,'Oct',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>October </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsoct->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Oct'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsnov=UserController::annpermonth($lists->id,'Nov',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>November </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsnov->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Nov'}}/{{$lists->id}}/{{$ann}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
...
<br/><br/>
<?php $conlistsdec=UserController::annpermonth($lists->id,'Dec',$anns); ?>
<table width="100%"><tr>
                            <td width="80%">
                    <h1>December </h1><td>
                        <td>
                        ...
                        <?php  if($conlistsdec->count()>0){?>
                            <a href="/users/annmonthExtract/{{'Dec'}}/{{$lists->id}}/{{$anns}}/{{$annids}}" class="button box bg-theme-9 mt-3 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="external-link" class="breadcrumb__icon"></i> Extract celebrants </a>
