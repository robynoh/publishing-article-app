...
<div class="flex items-center px-5 py-5 sm:py-3 border-b border-gray-200">
                                    ...
                                    <div class="dropdown relative ml-auto sm:hidden">
                                        ...
                                        <div class="dropdown-box mt-5 absolute w-40 top-0 right-0 z-20">
                                            ...
                                            <a href="/users/new_field" class="flex items-center p-2 transition duration-300 ease-in-out bg-white hover:bg-gray-200 rounded-md"><i data-feather="chevron-left" class="w-6 h-6 mr-2"></i> Go Back </a> 
                                    ...
                                    <a href="/users/new_field" class="button border relative flex items-center text-gray-700 hidden sm:flex"> <i data-feather="chevron-left" class="w-6 h-6 mr-2"></i> Back </a>
...
<div class="px-5 mt-5 ">
                         ...
                         <div class="text-gray-600 text-center mt-2">Enter the question you want to create, choose the type of answer you want and click "Save" button </div>
                    </div>
                    ...
                    <div class="px-5 sm:px-20   mt-5">
                       ...
                       <div> <label><b>Question</b></label>
                        <input name="fieldname" id="title" type="text" class="input w-full border mt-2" placeholder="Enter your question here" value="{{ old('fieldname') }}"> </div>
<br/>
...
<div class="flex items-center text-gray-700 mr-2" style="font-size:14px">  <input name="description" id="title" type="text" class="input w-full border mt-2" placeholder="Enter any further information needed to understand this question " value="{{ old('description') }}"> </label> </div>
