...
SMS will be sent to contacts in all list bellow automatically on the scheduled time.
</div>
...
<?php }?>
                        ...
                        <tbody>
                          @foreach($lists as $list) 
                            <tr>
                                ...
                                <td class="border-b">
                                    <div class="font-medium whitespace-no-wrap" style="color:#090"><?php if(Usercontroller::get_list_type_brand($list->listID)=='other'){ echo 'Anniversary';} if(Usercontroller::get_list_type_brand($list->listID)=='phonebook'){ echo 'Phonebook';}else{ echo ucwords(Usercontroller::get_list_type_brand($list->listID));} ?></div>
                                ...
                                <td class="border-b w-5">
                                    ...
                                    <a class="button w-32 mr-2 mb-2 flex items-center justify-center bg-theme-1 text-white" href="/users/scheduleUpdate/{{$list->id}}/{{$list->sendtype}}/{{ UserController::get_list_type($list->listID)}}"><i data-feather="settings" class="w-4 h-4 mr-1"></i> Settings</a>
     ...
     <div class="modal__content">
         ...
         <div class="p-5 "> <label><b>Choose how you want  to autosend SMS to your contacts</b></label>
     <div class="flex items-center text-gray-700 mt-2"> <input name="autotype" type="radio" class="input border mr-2" id="vertical-radio-chris-evans" name="vertical_radio_button" value="1" required> <label class="cursor-pointer select-none" for="vertical-radio-chris-evans">Send same SMS to all my contacts (Birthdays)</label> </div>
     <div class="flex items-center text-gray-700 mt-2"> <input name="autotype" type="radio" class="input border mr-2" id="vertical-radio-liam-neeson" name="vertical_radio_button" value="2" required> <label class="cursor-pointer select-none" for="vertical-radio-liam-neeson">Send different SMS to my contacts (Birthdays & Anniversary)</label> </div>
     <div class="flex items-center text-gray-700 mt-2"> <input name="autotype" type="radio" class="input border mr-2" id="vertical-radio-liam-neeson" name="vertical_radio_button" value="3" required> <label class="cursor-pointer select-none" for="vertical-radio-liam-neeson">Send SMS to my contacts (Phonebook)</label> </div>
