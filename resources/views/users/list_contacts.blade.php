...
<form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
                ...
                <h2 class="intro-y text-lg font-medium mt-10">
                   Contacts <span style="font-weight:normal">(<?php echo Usercontroller::get_list_type_brand($lists->id); ?>)</span>
                </h2>
<br/>
...
<a href="{{url()->previous()}}" class="button box bg-theme-1 text-white mr-2 flex items-center  ml-auto sm:ml-0">
                        <i data-feather="chevron-left" class="breadcrumb__icon"></i>     Back </a>
                            ...
                            <td>  <?php if($contactlists->count()>0){?> <button type="submit" class="button w-40 mr-2  flex items-center justify-center bg-theme-9 text-white"> <i data-feather="save" class="w-4 h-4 mr-2"></i> Save Changes </button>   <?php }?>          
</td>
</tr>
...
<div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <?php }?>
                    <?php if($contactlists->count()>0){?>                       <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11" style="font-size:15px">  Type in birthday wishes you want to send to contact and choose your desired time to send SMS if not okay with the default.  </div>
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <input type="hidden", name="contactid[]" value="{{$contactlist->birthMonth}}">
                                        ...
                                        <div class="text-gray-600 text-xs whitespace-no-wrap" style="color:#090">{{ucwords($contactlist->remarks)}}</div>
