...
@section('title')
    <title> User | Annniversary List  </title>
@endsection
@section('content')
...
<form action="/users/processmultiplemsgedit/{{$lists->id}}" method="POST">
{{ method_field("PUT")}}
{{ csrf_field() }} 
<table>
<tr>
...
<div class="grid grid-cols-12 gap-6 mt-5">
                ...
                <?php }?>
                    <?php if($contactlists->count()>0){?>                       <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11">  Type in anniversary wish you want to send to contact and choose your desired time to send message</div>
<table width="30%">

<tr>
<td>
<span>Select Sender ID</span><br/>
                    ...
                    <thead>
                            ...
                            <tbody>
                                ...
                                <tr class="intro-x">
                                    ...
                                    <td class="border-b">
                                    <input type="text", name="contactid[]" value="{{$contactlist->id}}">
